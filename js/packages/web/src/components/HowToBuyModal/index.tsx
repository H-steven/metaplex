...
export const HowToBuyModal: React.FC<HowToBuyModalProps> = ({
  ...
  return (
    <InstructionsModal
      ...
      modalTitle={`Buying NFTs on Loopro`}
      cardProps={[
        {
          title: 'Create a SOL wallet',
          imgSrc: '/modals/how-to-buy-1.svg',
          description: `SOL is the cryptocurrency we use for purchases on Loopro. To keep your SOL safe, you’ll need a crypto wallet—we recommend using one called Phantom. Just head to Phantom’s site, install the Chrome extension, and create an account.`,
        },
        {
        ...
        {
          title: `Connect your wallet to Loopro.`,
